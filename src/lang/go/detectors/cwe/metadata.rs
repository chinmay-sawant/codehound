...
pub(super) const META_CWE_15: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(15, "External control of configuration setting"),
...
pub(super) const META_CWE_22: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(22, "Path traversal via user-controlled path segment"),
    Some(
...
pub(super) const META_CWE_41: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(41, "Improper path equivalence resolution"),
    Some(
...
pub(super) const META_CWE_59: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(59, "Improper link resolution before file access"),
...
pub(super) const META_CWE_76: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(76, "Improper neutralization of equivalent special elements"),
...
pub(super) const META_CWE_78: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(78, "OS command built from user-controlled shell input"),
    Some(
...
pub(super) const META_CWE_79: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(79, "Unescaped user input during HTML page generation"),
...
pub(super) const META_CWE_89: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(89, "SQL query built from user-controlled input"),
...
pub(super) const META_CWE_90: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(90, "LDAP filter built from user-controlled input"),
...
pub(super) const META_CWE_91: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(91, "XML document assembled from user-controlled fields"),
    Some(
...
pub(super) const META_CWE_93: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(93, "CRLF sequences copied into HTTP header values"),
...
pub(super) const META_CWE_112: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(112, "Untrusted XML parsed without field validation"),
...
pub(super) const META_CWE_140: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(140, "CSV row built with naive delimiter concatenation"),
...
pub(super) const META_CWE_178: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(178, "Inconsistent case handling in resource lookup"),
    Some(
...
pub(super) const META_CWE_179: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(179, "Validation happens before URL decoding"),
...
pub(super) const META_CWE_184: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(184, "Incomplete list of disallowed inputs"),
    Some(
...
pub(super) const META_CWE_208: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(208, "Secret comparison leaks mismatch timing"),
    Some(
...
pub(super) const META_CWE_209: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(209, "Client response includes database error details"),
    Some(
...
pub(super) const META_CWE_212: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(212, "Sensitive payment fields are exported without removal"),
    Some(
...
pub(super) const META_CWE_214: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(214, "Sensitive token passed on a process command line"),
...
pub(super) const META_CWE_215: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(215, "Debug logging includes secret material"),
...
pub(super) const META_CWE_252: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(252, "Critical file write return value is ignored"),
...
pub(super) const META_CWE_256: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(256, "Plaintext password is stored directly"),
    Some(
...
pub(super) const META_CWE_257: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(257, "Password is stored in a recoverable encrypted format"),
    Some(
...
pub(super) const META_CWE_260: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(260, "Secret is loaded from a configuration file body"),
    Some(
...
pub(super) const META_CWE_261: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(261, "Password is stored using a reversible encoding"),
    Some(
...
pub(super) const META_CWE_262: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(262, "Credential age is never enforced"),
    Some(
...
pub(super) const META_CWE_263: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(263, "Password expiration window is set unreasonably long"),
    Some(
...
pub(super) const META_CWE_267: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(267, "Role is granted unsafe destructive capability"),
    Some(
...
pub(super) const META_CWE_268: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(268, "Privilege chaining exposes sensitive export behavior"),
    Some(
...
pub(super) const META_CWE_272: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(272, "Elevated uid is retained longer than required"),
    Some(
...
pub(super) const META_CWE_273: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(273, "Privilege drop result is ignored"),
...
pub(super) const META_CWE_274: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(274, "Insufficient privilege errors are treated as success"),
    Some(
...
pub(super) const META_CWE_277: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(277, "Cleared umask allows insecure inherited permissions"),
...
pub(super) const META_CWE_279: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(279, "Execution assigns broader permissions than requested"),
...
pub(super) const META_CWE_283: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(283, "File deletion proceeds without verifying ownership"),
    Some(
...
pub(super) const META_CWE_301: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(301, "Authentication proof reflects the client challenge"),
    Some(
...
pub(super) const META_CWE_305: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(305, "Debug flag bypasses primary authentication"),
    Some(
...
pub(super) const META_CWE_308: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(308, "High-value operation uses only a single factor"),
    Some(
...
pub(super) const META_CWE_312: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(312, "Sensitive identifier is stored in cleartext at rest"),
    Some(
...
pub(super) const META_CWE_322: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(322, "TLS key exchange skips peer authentication"),
...
pub(super) const META_CWE_323: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(323, "AEAD encryption reuses a fixed nonce"),
    Some(
...
pub(super) const META_CWE_324: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(324, "Expired signing key is still used"),
...
pub(super) const META_CWE_325: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(325, "Encryption omits an integrity-protection step"),
    Some(
...
pub(super) const META_CWE_328: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(328, "Weak hash algorithm is used for password storage"),
...
pub(super) const META_CWE_331: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(331, "Recovery code uses insufficient entropy"),
    Some(
...
pub(super) const META_CWE_334: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(334, "Invite token comes from a very small random space"),
    Some(
...
pub(super) const META_CWE_335: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(335, "PRNG is seeded from predictable wall-clock time"),
    Some(
...
pub(super) const META_CWE_342: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(342, "OTP is derived by incrementing the previous value"),
    Some(
...
pub(super) const META_CWE_346: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(346, "Origin is reflected without validation"),
    Some(
...
pub(super) const META_CWE_367: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(367, "File is checked with Stat before later use"),
    Some(
...
pub(super) const META_CWE_378: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(378, "Temporary file is created with insecure permissions"),
...
pub(super) const META_CWE_379: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(379, "Temporary directory uses insecure permissions"),
    Some(
...
pub(super) const META_CWE_385: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(385, "Secret comparison leaks timing through early exit"),
...
pub(super) const META_CWE_393: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(393, "Lookup failure returns a success status code"),
    Some(
...
pub(super) const META_CWE_408: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(408, "Expensive export happens before authentication check"),
...
pub(super) const META_CWE_412: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(412, "Client controls the externally accessible lock path"),
    Some(
...
pub(super) const META_CWE_421: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(421, "Alternate event channel races shared transfer state"),
...
pub(super) const META_CWE_426: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(426, "Plugin search path comes from the request"),
    Some(
...
pub(super) const META_CWE_459: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(459, "Sensitive temporary export file is never removed"),
...
pub(super) const META_CWE_472: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(472, "Hidden role field is trusted for authorization"),
    Some(
...
pub(super) const META_CWE_497: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(497, "Diagnostics expose host environment details"),
    Some(
...
pub(super) const META_CWE_521: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(521, "Password policy accepts trivially weak passwords"),
...
pub(super) const META_CWE_523: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(523, "Credentials are accepted over a cleartext listener"),
...
pub(super) const META_CWE_524: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(524, "Process-wide cache stores raw session tokens"),
    Some(
...
pub(super) const META_CWE_538: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(538, "Sensitive DSN is exported to a public file path"),
    Some(
...
pub(super) const META_CWE_547: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(547, "Signing secret is hard-coded in source"),
    Some(
...
pub(super) const META_CWE_549: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(549, "Password value is echoed back in an API response"),
...
pub(super) const META_CWE_552: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(552, "Uploaded documents are chmodded world-readable"),
    Some(
...
pub(super) const META_CWE_565: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(565, "Privileged delete trusts an unverified role cookie"),
    Some(
...
pub(super) const META_CWE_603: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(603, "Server trusts a caller-supplied authenticated header"),
    Some(
...
pub(super) const META_CWE_605: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(605, "Listener enables SO_REUSEADDR on a service socket"),
    Some(
...
pub(super) const META_CWE_611: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(611, "Untrusted XML is parsed with strict mode disabled"),
...
pub(super) const META_CWE_613: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(613, "Session cookie never expires and is not revoked"),
...
pub(super) const META_CWE_619: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(619, "Database cursor is left open on an early return path"),
...
pub(super) const META_CWE_620: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(620, "Password change does not verify the current password"),
    Some(
...
pub(super) const META_CWE_645: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(645, "Account lockout triggers after a single failed login"),
    Some(
...
pub(super) const META_CWE_654: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(654, "Admin access relies only on a static API key header"),
...
pub(super) const META_CWE_756: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(756, "Raw database error text is returned to the client"),
...
pub(super) const META_CWE_765: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(765, "Mutex is unlocked twice on an error path"),
    Some(
...
pub(super) const META_CWE_778: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(778, "Authentication failures are not logged"),
...
pub(super) const META_CWE_798: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(798, "Database credentials are hard-coded in source"),
...
pub(super) const META_CWE_807: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(807, "Security decision trusts a spoofable client header"),
    Some(
...
pub(super) const META_CWE_820: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(820, "Shared map is updated without synchronization"),
...
pub(super) const META_CWE_821: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(821, "Shared cache is mutated under a read lock"),
...
pub(super) const META_CWE_836: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(836, "Authentication trusts a client-supplied password hash"),
    Some(
...
pub(super) const META_CWE_841: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(841, "Password reset workflow skips the MFA completion step"),
    Some(
...
pub(super) const META_CWE_917: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(917, "User input is concatenated into template source"),
...
pub(super) const META_CWE_1052: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(1052, "Database initialization embeds a full DSN literal"),
    Some(
...
pub(super) const META_CWE_1204: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(1204, "CBC encryption reuses a static initialization vector"),
    Some(
...
pub(super) const META_CWE_1240: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(1240, "Custom XOR cipher is used for token protection"),
    Some(
...
pub(super) const META_CWE_1322: RuleMetadata = emit::rule_meta(
    ...
    Severity::Warning,
    go_cwe_ref_slice!(1322, "Async worker blocks its event loop with sleep calls"),
    Some(
...
pub(super) const META_CWE_1327: RuleMetadata = emit::rule_meta(
    ...
    Severity::High,
    go_cwe_ref_slice!(1327, "Service binds to all interfaces by default"),
