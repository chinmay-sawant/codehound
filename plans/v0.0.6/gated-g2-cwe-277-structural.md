...
> **Refresh:** [`evidence-g2-cwe-277-reopen.md`](./evidence-g2-cwe-277-reopen.md) (2026-07-23)  
> **Status:** Deferred — keep Heuristic (0/376 canary Phase 5 + 2026-07-23)

## Checklist

### Reopen gates
- [ ] Reviewed actionable real-module hit for CWE-277 — **FAIL 2026-07-23** (0/376)
- [ ] Mode-variant / scope negatives as needed (`0o777`, umask variants) — N/A until hit
- [ ] Audit §1.3 bar fully met — blocked
- [ ] Maturity + profile + tests in same change — blocked
...
- [x] 2026-07-23: no Structural ship after refresh
