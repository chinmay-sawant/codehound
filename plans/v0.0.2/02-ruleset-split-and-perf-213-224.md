...
> **Parent:** `plans/v0.0.2/` — post-catalog-extension implementation
...
- [~] ~~Archive `plans/perf-batch-4.md` → `plans/v0.0.2/archive/`~~ (still open — file at `plans/perf-batch-4.md` not yet moved) (deferred → see plans/v0.0.3/)
