...
> **Parent:** `plans/v0.0.2/pending-work/01-taint-tracking-remaining.md`
...
- [~] Add a `cargo test --all-features` run with taint enabled to CI (deferred → see plans/v0.0.3/)
...
- [~] Run `cargo test --all-features` after each phase (deferred → see plans/v0.0.3/)
