...
- [x] Create `documents/bad-practices.md` — one paragraph per BP rule with rationale and canonical fix. Source: `plans/v0.0.2/antipattern-remediation/bad-practices-scope.md` (also tracked in `05-cross-cutting-remaining.md`)
