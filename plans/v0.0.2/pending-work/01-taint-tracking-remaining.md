...
> **See also:** `plans/p2-remaining-work.md` § P2.1, `plans/v0.0.2/pending-work/05-taint-cli-and-docs.md`
...
> **Status:** ✅ Implemented (see `plans/v0.0.2/p1f-inter-procedural-taint.md` for full scope). Most items done; remaining items tracked in deferred.
