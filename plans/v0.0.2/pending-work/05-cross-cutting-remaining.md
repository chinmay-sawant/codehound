...
> **See also:** Individual plans at `plans/v0.0.2/pending-work/01-taint-tracking-remaining.md`, `02-perf-detectors-remaining.md`, `03-bad-practices-remaining.md`, `04-cache-incremental-remaining.md`
...
- [x] Create `documents/bad-practices.md` covering:
  ...
  - Source: adapted from `plans/v0.0.2/antipattern-remediation/bad-practices-scope.md`
...
- [~] Action: no work planned `(deferred → see plans/v0.0.3/)`
